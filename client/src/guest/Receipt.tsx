    ...
    <div className="flex h-screen w-full items-center justify-center bg-gray-600">
      <div className="w-80 rounded bg-gray-50 px-6 pt-4 shadow-lg">
        ...
        <div className="flex flex-col justify-center items-center gap-2">
          ...
          {/* <h4 className="font-semibold">The Marison Hotel</h4> */}
          <p className="text-xs italic text-slate-500 ">Corner Imelda Roces Ave, Legazpi City, Albay</p>
        </div>
        <div className="flex flex-col gap-3 border-b py-6 text-xs">
          ...
          {/* <p className="flex justify-between">
            <span className="text-gray-500 font-mono">Booked Rooms:</span>
            <span>1 Deluxe King </span>
          </p> */}
        </div>
        <div className="flex flex-col gap-3 pb-6 pt-2 text-xs">
          <table className="w-full text-left">
            <thead>
              <tr className="flex">
                <th className="w-full py-2 italic text-slate-600">Reservations and Services Availed</th>
            ...
            <tbody>
              <tr className="flex">
                <td className="flex-1 py-1">Deluxe King</td>
                <td className="min-w-[44px]">1</td>
                <td className="min-w-[44px]">P 4600</td>
              </tr>
              <tr className="flex py-1">
                <td className="flex-1">Shuttle Service</td>
                <td className="min-w-[44px]"></td>
                <td className="min-w-[44px]">N/A</td>
              </tr>
            </tbody>
          </table>
          ...
          <div className=" justify-center items-center flex flex-col gap-2">
            <p className="flex gap-2 w-20 h-20">
              <img
                src="public/qr-placeholder.png"
              />
            </p>
            <p className="flex gap-2 s">
              <svg
