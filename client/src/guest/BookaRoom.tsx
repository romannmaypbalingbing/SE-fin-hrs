                 ...
                 <div className="bg-white p-6 shadow-md rounded-lg h-full self-start">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <p className="text-base font-semibold text-slate-800">{selectedRoom?.roomtype_name}</p>
                        </div>
                        <div className="flex justify-between items-center">
                            <p className="text-base text-slate-600">Price per night:</p>
                            <p className="text-base font-semibold text-slate-800">{selectedRoom?.roomtype_price}</p>
                        </div>
                        <div className="flex justify-between items-center">
                            <p className="text-base text-slate-600">Guests:</p>
                            <p className="text-base font-semibold text-slate-800">{selectedRoom?.roomtype_capacity}</p>
                        </div>
